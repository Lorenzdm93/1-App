...
function PillIcon({ size = 18 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" aria-hidden="true">
      <rect x="2.8" y="4.6" width="18.4" height="16.6" rx="4.2" stroke="currentColor" strokeWidth="1.9" />
      <path d="M8 2.4v4.4M16 2.4v4.4M2.8 10.2h18.4" stroke="currentColor" strokeWidth="1.9" strokeLinecap="round" />
      <path d="m8.5 15.4 2.4 2.4 4.8-5" stroke="currentColor" strokeWidth="2.1" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  )
}
